...
export default function HealthRecords() {
  ...
  const summary = useMemo(() => {
    ...
    return {
      ...
      activePrescriptions,
      criticalReports,
      latestVital: latestVital ? formatDate(latestVital.createdAt) : "",
      latestReport: latestReport ? formatDate(latestReport.date || latestReport.createdAt) : "",
    };
...
function TrendGraphs({ chartData, profile, summary, vitals }) {
  const latestVital = vitals[0];
  const latestRows = [
    [
      "Blood Group",
  ...
  return (
    <div className={styles.healthSidebar}>
      <div className={styles.sidebarHeader}>
        ...
        <p>Latest useful signals from your records.</p>
      </div>
      ...
      <div className={styles.trendGrid}>
        ...
        <div className={styles.summaryCard}>
          <div className={styles.summaryTitle}>Recent Activity</div>
          <div className={styles.summaryRow}>
            <span>Latest Vital</span>
            <span className={styles.normal}>{summary.latestVital || "None"}</span>
          </div>
          <div className={styles.summaryRow}>
            <span>Latest Report</span>
            <span className={styles.normal}>{summary.latestReport || "None"}</span>
          </div>
        </div>
      </div>
    </div>
